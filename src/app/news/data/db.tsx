export const newsData = [
  {
    ...
    date: "11/26/2024",
    img: "/news/thumbnail/supervive-roadmap.png",
    description: "Come see what's cooking. We're just getting started!",
    slug: "dev-roadmap-to-the-future-of-supervive",
    data: {
      introduction: {
        img: "/news/thumbnail/supervive-roadmap.png",
        title: "[DEV ROADMAP] To the future of SUPERVIVE!",
      ...
      custom: [
        {
          title: "Hey SUPERVIVERS",
          img: "/news/roadmap/lifetime-players.png",
          description: [
            "> note: looking for IMMEDIATE action?",
            {
              type: "link",
              link: "/patch-notes/patch-1-01-notes",
              anchorText: "Go read our week 1 patch notes here",
            },
          ],
          notes: [
        ...
        },
        {
          ...
          img: "/news/roadmap/roadmap-current-position.png",
          description: [],
          notes: [
        ...
        {
          title: "NOV/DEC - OPEN BETA & THE COSMIC WINTER JUBILEE",
          img: "/news/roadmap/roadmap-nov-dec-2024.png",
          description: [],
          notes: [
        ...
        {
          title: "JAN/FEB/MAR - SEASON 0, ARC 1: [REDACTED]’S WARPED TOUR",
          img: "/news/roadmap/roadmap-jan-feb-mar-2025.png",
          description: [],
          notes: [
        ...
        {
          title: "APR/MAY/JUN - SEASON 0, ARC 2: [REDACTED] of [REDACTED]",
          img: "/news/roadmap/roadmap-apr-may-jun-2025.png",
          description: [],
          notes: [
